...
public class GlobalExceptionHandler {
    ...
    @ExceptionHandler(AnomalyStateException.class)
    public ResponseEntity<ErrorResponse> handleAnomalyState(AnomalyStateException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(ErrorResponse.of(HttpStatus.CONFLICT.value(), ex.getMessage()));
    }

    @ExceptionHandler(SupportTicketException.class)
    public ResponseEntity<ErrorResponse> handleSupportTicket(SupportTicketException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ErrorResponse.of(HttpStatus.BAD_REQUEST.value(), ex.getMessage()));
    }

    @ExceptionHandler(NotificationOutboxException.class)
    public ResponseEntity<ErrorResponse> handleNotificationOutbox(NotificationOutboxException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ErrorResponse.of(HttpStatus.BAD_REQUEST.value(), ex.getMessage()));
    }
    ...
    @ExceptionHandler(TicketAiAssessmentException.class)
    public ResponseEntity<ErrorResponse> handleTicketAiAssessmentException(TicketAiAssessmentException ex) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ErrorResponse.of(HttpStatus.BAD_REQUEST.value(), ex.getMessage()));
    }

    @ExceptionHandler(TicketAiAssessmentStateException.class)
    public ResponseEntity<ErrorResponse> handleTicketAiAssessmentStateException(TicketAiAssessmentStateException ex) {
        return ResponseEntity.status(HttpStatus.CONFLICT)
                .body(ErrorResponse.of(HttpStatus.CONFLICT.value(),ex.getMessage()));
    }
    ...
    @ExceptionHandler(SupportTicketAssignmentException.class)
    public ResponseEntity<ErrorResponse> handleSupportTicketAssignmentException(
            SupportTicketAssignmentException ex
    ) {
        return ResponseEntity.status(HttpStatus.BAD_REQUEST)
                .body(ErrorResponse.of(HttpStatus.BAD_REQUEST.value(),ex.getMessage()));
    }
